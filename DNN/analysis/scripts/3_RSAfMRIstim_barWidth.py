    ...
    for l, layer in theseLayers:
        ...
        for dataset in datasets:
            for barWidth in [2, 4, 8, 16]:
                ...
                analysisDir = f'DNN/analysis/results/RSAfMRIstim/various/{model}/{dataset}/{barWidth}'
                ...
                for occluder in occluders:
                    ...
                    allResponses = []
                    responseDir = os.path.join(modelDir, f'responses/fMRIstim/various/{barWidth}')
                    ...
                    # dont normalize patterns
                    responsesNormed = responses
                    '''
